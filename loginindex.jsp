<%-- 
    Document   : loginindex
    Created on : 25 Jun, 2019, 10:29:47 AM
    Author     : Mayank
--%>
...
$("#services").show();
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" button class="btn btn-primary btn-lg" href="index.jsp">Log out</button></a>
             <%
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"style="background-color: #fec503">
        <h5 class="modal-title" id="myModalLabel" text-center >Log out</h5>
      </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="email" class="form-control" id="inputEmail3" name="t1" placeholder="Email">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        ...
        <u><a href="#" >Register now!</a></u></h4><br><p>It is easy and done in 1 minute and gives you access to special discounts and more!!!<p>

  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
       <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" name="b1">Log in</button>
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">Welcome To GET!T!
          ...
          <ul class="timeline">
            <li>
              <div class="timeline-image">
                  <a href="repair.jsp"><img class="rounded-circle img-fluid" src="img/about/1.jpg" alt=""></a>
              </div>
            ...
            <li class="timeline-inverted">
              <div class="timeline-image">
                  <a href="health.jsp"><img class="rounded-circle img-fluid" src="img/about/2.jpg" alt=""></a>
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
            ...
            <li>
              <div class="timeline-image">
                  <a href="tutor.jsp"><img class="rounded-circle img-fluid" src="img/about/3.jpg" alt=""></a>
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
            ...
            <li class="timeline-inverted">
              <div class="timeline-image">
                  <a href="health.jsp"><img class="rounded-circle img-fluid" src="img/about/4.jpg" alt=""></a>
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>Saloon Services</h4>
                  <h4 class="subheading">brief</h4>
                </div>
                <div class="timeline-body">
                  <p class="text-muted">details</p>
